...
public class AppmemoryActivity extends AppCompatActivity {
        ...
        btnaddmem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(titlestring.equals("")|| detailstring.equals("")){
                    Toast.makeText(AppmemoryActivity.this,"ข้อมูลไม่ครบ ถ้วน",Toast.LENGTH_SHORT).show();
                }else{
                    memOpenHelper.addmemory(titlestring,detailstring,datestring);
                    Toast.makeText(AppmemoryActivity.this,"บันทึก เรียบร้อย",Toast.LENGTH_SHORT).show();
                            Intent gotomain = new Intent(AppmemoryActivity.this,MainActivity.class);
